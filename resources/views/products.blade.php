        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><img src="{{ asset('images/' . $product['product_image']) }}" width="100"
                        ...
                        <td>
                            <form method="post" action="{{ route('delete', ['id' => $product['id']]) }}">
                                @csrf
                                @method('DELETE')
                        <a href="{{ route('viewprod', ['id' => $product['id']]) }}" class="btn btn-sm my-1">View</a>
                        
                        <a href="{{ route('editprod', ['id' => $product['id']]) }}" class="btn btn-sm my-1">Edit</a>
